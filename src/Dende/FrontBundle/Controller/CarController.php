...
class CarController extends Controller
{
    ...
    public function addAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                $car = $form->getData();
                $this->get('dende.front.form_handler.car')->setCar($car)->handle($form);
    ...
    public function editAction(Request $request, Car $car)
    {
        ...
        $this->get('dende.front.form_handler.process_images')->setOriginalImages($car->getImages());
        $this->get('dende.front.form_handler.process_prices')->setOriginalPrices(clone($car->getPrices()));

...
/**
 * @ORM\Entity(repositoryClass="LAH\FrontBundle\Repository\CarRepository")
 * @ORM\Table(name="cars")
 * @codeCoverageIgnore
 * @Gedmo\SoftDeleteable(fieldName="deleted")
 * @Gedmo\TranslationEntity(class="LAH\FrontBundle\Entity\Translation\CarTranslation")
...
class Car implements Translatable
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LAH\FrontBundle\Entity\Type")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LAH\FrontBundle\Entity\Model", inversedBy="cars")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LAH\FrontBundle\Entity\Color")
    ...
    /**
     * @ORM\OneToMany(targetEntity="LAH\FrontBundle\Entity\Price", mappedBy="car", cascade={"remove", "persist"})
     *
     * @var Price[]
     *
     * @Assert\Count(
    ...
    /**
     * @ORM\OneToOne(targetEntity="LAH\FrontBundle\Entity\Image")
    ...
    /**
     * @ORM\OneToMany(targetEntity="LAH\FrontBundle\Entity\Image", mappedBy="car", cascade={"remove", "persist"})
     *
    ...
    /**
     * @ORM\OneToMany(
     *   targetEntity="LAH\FrontBundle\Entity\Translation\CarTranslation",
     *   mappedBy="object",

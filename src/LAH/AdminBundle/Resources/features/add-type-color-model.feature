Feature: I can add cars using form
  ...
  Scenario: I can add a new type of a car
    ...
    And I fill in "lah_car_add_type_name" with "some test"
    ...
    And the "input#lah_car_add_type_name" element should contain ""
  ...
  Scenario: I can add a new color of a car
    ...
    And I fill in "lah_car_add_color_translations_pl_name" with "some color"
    ...
    Then I can't see "Kolor" row
    And I can see "Nowy kolor" row
    And the "input#lah_car_add_color_translations_pl_name" element should contain ""
  ...
  Scenario: I can add a new model and a brand of a car
    ...
    And I fill in "lah_car_add_model_name" with "some model"
    And I fill in "lah_car_add_model_brand" with "some brand"
    ...
    Then I can't see "Model" row
    And I can see "Nowy model" row
    And the "input#lah_car_add_model_name" element should contain ""
    And the "input#lah_car_add_model_brand" element should contain ""
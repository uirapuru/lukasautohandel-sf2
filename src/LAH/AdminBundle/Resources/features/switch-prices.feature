Feature: I can add cars using form
  ...
  Scenario: Add price and change it's currency
    ...
    When I fill in "lah_car_prices_0_amount" with "100"
    And I fill in "lah_car_prices_1_amount" with "10000"
    And I fill in "lah_car_prices_2_amount" with "-15"
    ...
    When I fill in "lah_car_prices_2_amount" with "100"

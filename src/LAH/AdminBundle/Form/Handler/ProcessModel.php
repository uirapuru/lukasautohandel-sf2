...
class ProcessModel
{
    ...
    public function addModel()
    {
        ...
        if (!is_null($newModelName)) {
            $model = $this->entityManager->getRepository('LAHMainBundle:Model')->findOneByName($newModelName);
            ...
            $brand             = $this->entityManager->getRepository('LAHMainBundle:Brand')->findOneByName($newModelBrandName);
